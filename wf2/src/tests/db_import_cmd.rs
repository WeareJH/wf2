...
mod tests {
    ...
    fn test_db_import_no_pv() {
        ...
        let expected =
            r#"docker exec -i wf2__wf2_default__db mysql -udocker -pdocker docker < "file.sql""#;
    ...
    fn test_db_import_pv() {
        let args = vec!["prog", "db-import", "file.sql"];
        let expected = r#"pv -f "file.sql" | docker exec -i wf2__wf2_default__db mysql -udocker -pdocker -D docker"#;
